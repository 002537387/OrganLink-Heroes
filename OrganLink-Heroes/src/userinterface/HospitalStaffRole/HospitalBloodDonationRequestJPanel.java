 ...
 * @author Ing-Ruei
 */
public class HospitalBloodDonationRequestJPanel extends javax.swing.JPanel {

    /**
     * Creates new form BoneMarrowRequestJPanel
     */
    private UserAccount userAccount;
    private HospitalOrganization marroworganization;
    private Enterprise enterprise;
    private Network network;
    private DB4OUtil dB4OUtil = DB4OUtil.getInstance();
    private EcoSystem system;

    public HospitalBloodDonationRequestJPanel(UserAccount userAccount, HospitalOrganization bmBankOrganization, Enterprise enterprise, Network network, EcoSystem system) {
        initComponents();
